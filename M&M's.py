"""
NAME: M&M.py
PURPOSE: plot a 3D graph in matplotlib with M&M's.csv data
DATE: 5/4/24
PROGRAMMER: Dr Hac
"""
...
# read data from the M&M's.csv file
MnM = pd.read_csv("M&M's.csv", usecols=['Color', 'Normal', 'Peanut', 'Peanutbutter', 'Total'], index_col=0)
